...
#  By observing the patter we see that z %% 26 is equal to d[j] + var3[j]
#    where j is the last index where equality was not achieved
# Therefore each equality is a condition on two separate digits
#   this equations always are of the form d[j] + var3[j] + var2[i] = d[i]
